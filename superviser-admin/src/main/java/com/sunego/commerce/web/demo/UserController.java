package com.sunego.commerce.web.demo;
...
import com.sunego.commerce.common.superviser.FastJsonUtils;
...
public class UserController {
    ...
    public String listCompound(@ApiParam(required = true, name = "start", value = "start") int start, int limit,
